...
class Actions():
    ...
    def create_window(self):
        ...
        self.console_task_names = ['Console3UIProcess','ConsoleFlabProcess']
        self.plot_setup()
    ...
    def open_project(self, project_path, new = True):
        ...
        self.message('Loading tasks, devices, uis, data and models')
    ...
    def click_start_task(self):
        try:
            ...
            if tasks != '':
                for i in tasks:
                    task_name = i.text()
                    full_args = inspect.getfullargspec(self.flab.tasks[task_name].get('run'))
    ...
    def click_load_ui(self):
        self.click_load_object('\\UIs','uis')
        self.list_loaded_uis()
